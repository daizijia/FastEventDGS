...
def loadCam(args, id, cam_info, resolution_scale):
    ...
    return Camera(colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T,
                  ...
                  depth=cam_info.depth,events=cam_info.events, image_timestamp=cam_info.image_timestamp, 
                  closest_event_index=cam_info.closest_event_index, w = int(cam_info.width), h = int(cam_info.height))
